...
export default function ShopSmartWatches() {
  return (
    <>
                    ...
                    <div className="col-md-4">
                        <div className="card mb-4 product-wap rounded-0">
                            <div className="card rounded-0">
                                <img className="card-img rounded-0 img-fluid" src="assets/img/watch.jpg" alt=''/>
                            </div>
                            <div className="card-body">
                                <Link to="/ShopSingleGalaxyWatch" className="h3 text-decoration-none">Samsung Galaxy Watch 5</Link>
                                ...
                                <p className="text-center mb-0">Rs60,000</p>
                            </div>
                        </div>
                    </div>
                </div>
