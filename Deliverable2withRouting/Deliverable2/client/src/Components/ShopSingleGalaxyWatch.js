...
export default function ShopSingleGalaxyWatch() {
  const [quantity, setQuantity] = useState(1);
  const [galaxywatchID, setGalaxyWatchID] = useState("04");
  ...
  function handleClick() {
    const newWindow = window.open('http://localhost:3000/GalaxyWatchModel', '_blank');
  }
          ...
          <div className="row">
            <div className="col-lg-5 mt-5">
              <div className="card mb-3">
                <img className="card-img img-fluid" src="assets/img/watch.jpg" alt="Card image cap" id="product-detail" />
              </div>
              <div className="row">
                {/* Start Controls */}
      ...
      <div id="multi-item-example" className="col-10 carousel slide carousel-multi-item" data-bs-ride="carousel" >
        ...
        <div className="carousel-inner product-links-wap" role="listbox">
          ...
          <div className="carousel-item active">
            <div className="row">
              <div className="col-4">
                  <img className="card-img img-fluid" src="assets/img/watch1.jpg" alt="Product Image 1" />
              </div>
              <div className="col-4">
                  <img className="card-img img-fluid" src="assets/img/watch2.jpg" alt="Product Image 2" />
              </div>
              <div className="col-4">
                  <img className="card-img img-fluid" src="assets/img/watch3.jpg" alt="Product Image 3" />
              </div>
            </div>
          </div>
          {/*/.First slide*/}
    ...
    <div className="col-lg-7 mt-5" style={{ width: "50%"}}>
      <div className="card">
        <div className="card-body">
          <h1 className="h2">Samsung Galaxy Watch 5</h1>
          <p className="h3 py-2">Rs.60,000</p>
          <p className="py-2">
          ...
          <h6>Description:</h6>
          <p>40mm Bluetooth Smartwatch w/ Body, Health, Fitness and Sleep Tracker, Improved Battery, Sapphire Crystal Glass, Enhanced GPS Tracking, US Version, Silver Bezel w/ Purple Band</p>

          <h6>Specification:</h6>
          <ul className="list-unstyled pb-3">
            <li>1.55 x 1.59 x 0.39 inches</li>
            <li>1 Lithium Polymer batteries required</li>
            <li>Bluetooth </li>
