...
export default function ShopVRHeadsets() {
  return (
    <>
                    ...
                    <div className="col-md-4">
                        <div className="card mb-4 product-wap rounded-0">
                            <div className="card rounded-0">
                                <img className="card-img rounded-0 img-fluid" src="assets/img/vr.jpg" alt=''/>
                            </div>
                            <div className="card-body">
                                <Link to="/ShopSingleMetaQuest" className="h3 text-decoration-none">Meta Quest 2</Link>
                                ...
                                <p className="text-center mb-0">Rs100,000</p>
                            </div>
                        </div>
                    </div>
                </div>
